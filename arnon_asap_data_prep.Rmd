...
readr::write_tsv(data, file.path("arnon_data", "normalized_arnon", "arnon_counts.tab"))
...
readr::write_delim(data.frame(batch.info), file.path("arnon_data", "batch.info.txt"))
```
```
