...
# Save to png
ggplot2::ggsave(main.plot, 
                filename = file.path("results", "darmanis_cell_type_tsne.png"))
...
# Save to png
ggplot2::ggsave(main.plot, 
                filename = file.path("results", "darmanis_batch_tsne.png"))
...
ggplot2::ggsave(plot = celltype.plot,
                filename = file.path("results", "darmanis_cell_type_stats_plots.png"),
                width = 10)
...
ggplot2::ggsave(plot = batch.plot, 
                filename = file.path("results", "darmanis_batch_stats_plots.png"),
                width = 10)
