...
readr::write_tsv(data, file.path("darmanis_data", "normalized_darmanis", "darmanis_counts.tab"))
...
readr::write_delim(data.frame(batch.info), file.path("darmanis_data", "batch.info.txt"))
```
