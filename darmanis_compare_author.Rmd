...
```{r}
plot(density(as.numeric(tx.counts[4,-1])))
...
png("results/Darmanis_sample_max_density.png")
plot(density(apply(tx.counts[,-1], 2, max)), main = "Sample Max Counts Distribution")
dev.off()

apply(tx.counts[,-1], 2, max)
