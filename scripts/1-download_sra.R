# A script to download a single file from command line
library(optparse)
library(SRAdb)

# Get options from command line
option_list <- list( 
  make_option(opt_str = c("-s", "--sample"), type = "character", default = NULL,
              help = "SRR Run Sample ID of the RNA-seq data you would like to download
              For multiple samples, separate ids by a comma and no spaces 
              eg. SRR3934349,SRR3934348", metavar = "character"),
